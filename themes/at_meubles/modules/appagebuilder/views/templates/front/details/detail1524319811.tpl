...
*}
<section id="main" class="product-detail sample_product_5 product-image-thumbs no-thumbs" itemscope itemtype="https://schema.org/Product">
  <meta itemprop="url" content="{$product.url}"><div class="row"><div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12 col-sp-12">{block name='page_header_container'}
...
{/block}
							</div><div class="col-xl-5 col-lg-5 col-md-6 col-sm-12 col-xs-12 col-sp-12">{block name='page_content_container'}
...
{/block}
							</div><div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-xs-12 col-sp-12">{if $product.is_customizable && count($product.customizations.fields)}
