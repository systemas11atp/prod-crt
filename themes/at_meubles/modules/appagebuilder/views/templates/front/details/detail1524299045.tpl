...
*}
<section id="main" class="product-detail sample_product_6 product-image-thumbs no-thumbs" itemscope itemtype="https://schema.org/Product">
...
{/block}
							</div><div class="offset-lg-2 offset-xl-2 col-xl-8 col-lg-8 col-md-12 col-sm-12 col-xs-12 col-sp-12">{block name='page_header_container'}
...
{/block}{include file="sub/product_info/tab.tpl"}
							</div><div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-sp-12">{block name='product_accessories'}
  {if $accessories}
