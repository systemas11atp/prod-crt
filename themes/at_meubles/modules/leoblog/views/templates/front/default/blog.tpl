				...
				{if $is_active}
					...
					<div class="blog-meta">
						...
						<span class="blog-author">
							<span><i class="fa fa-user"></i> {l s='Posted By' d='Shop.Theme.Global'}:</span> 
						...
						<span class="blog-cat"> 
							<span><i class="fa fa-files-o"></i> {l s='In' d='Shop.Theme.Global'}:</span>
						...
						<span class="blog-created">
							<span><i class="fa fa-calendar"></i> {l s='On' d='Shop.Theme.Global'}: </span>
						...
						<span class="blog-ctncomment">
							<span><i class="fa fa-comments-o"></i> {l s='Comment' d='Shop.Theme.Global'}:</span> 
							{$blog_count_comment|intval}
						</span>
						{/if}
						{if isset($blog->hits)&&$config->get('item_show_hit','1')}
						<span class="blog-hit">
							<span><i class="fa fa-heart"></i> {l s='Hit' d='Shop.Theme.Global'}:</span> 
							{$blog->hits|intval}
						</span>
						{/if}
					</div>
