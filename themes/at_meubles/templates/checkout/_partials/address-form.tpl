...
{block name='form_buttons'}
  {if !$form_has_continue_button}
    <button type="submit" class="btn btn-outline float-xs-right">{l s='Save' d='Shop.Theme.Actions'}</button>
  ...
  {else}
    <form>
      <button type="submit" class="continue btn btn-outline float-xs-right" name="confirm-addresses" value="1">
