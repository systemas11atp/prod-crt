  ...
  <form action="{$urls.pages.password}" class="forgotten-password" method="post">
    ...
    <section class="form-fields">
      <div class="form-group center-email-fields">
        ...
        <button class="form-control-submit btn btn-outline hidden-xs-down" name="submit" type="submit">
          {l s='Send reset link' d='Shop.Theme.Actions'}
        </button>
        <button class="form-control-submit btn btn-outline hidden-sm-up" name="submit" type="submit">
